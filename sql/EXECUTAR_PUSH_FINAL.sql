-- ========================================
-- PUSH NOTIFICATIONS PARA COMUNIDADE - FINAL
...
-- 3. Trigger para curtidas (verifica se tabela existe)
DO $$
DECLARE
  v_table_name TEXT;
BEGIN
  -- Procurar tabela de likes (pode ser post_likes, community_post_likes, likes, etc)
