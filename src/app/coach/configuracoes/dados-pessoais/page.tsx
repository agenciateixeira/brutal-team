...
import DadosPessoaisForm from '@/components/aluno/settings/DadosPessoaisForm';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Gerencie suas informações pessoais e controle da conta
          </p>
        </div>

        {/* Form */}
        <DadosPessoaisForm profile={profile} userEmail={session.user.email || ''} />
      </div>
    </AppLayout>
  );
}
