  ...
  const settingsCards = [
    {
      ...
      icon: Bell,
      href: '/coach/configuracoes/notificacoes',
    ...
    },
    {
      ...
      icon: User,
      href: '/coach/configuracoes/perfil',
    ...
    },
    {
      ...
      icon: Shield,
      href: '/coach/configuracoes/seguranca',
    ...
    },
    {
      ...
      icon: FileText,
      href: '/coach/configuracoes/dados-pessoais',
    ...
    },
    {
      ...
      icon: CreditCard,
      href: '/coach/configuracoes/assinatura',
