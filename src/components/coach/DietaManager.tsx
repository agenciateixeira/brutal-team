          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="px-2 py-1 bg-white dark:bg-gray-800 border-2 border-gray-900 dark:border-gray-300 text-gray-900 dark:text-gray-300 text-xs rounded-full hover:bg-blue-600 hover:border-blue-600 hover:text-white hover:scale-105 transition-all duration-200 cursor-default">
