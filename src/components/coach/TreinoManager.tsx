            ...
            <div className="flex flex-col sm:flex-row gap-2 mb-3">
              ...
              >
                ...
                <span className={`sm:hidden text-sm font-medium transition-colors group-hover:text-white ${
                  treino.active ? 'text-yellow-600' : 'text-green-600'
                }`}>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex gap-1">
                  {treino.workout_types.map((type) => {
                    ...
                    return (
                      <span key={type} className="px-2 py-1 bg-white dark:bg-gray-800 border-2 border-purple-600 text-purple-600 text-xs rounded-full hover:bg-purple-600 hover:text-white hover:scale-105 transition-all duration-200 cursor-default">
                        {typeLabel}
                      </span>
                    );
                  })}
