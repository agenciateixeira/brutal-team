-- ============================================
-- FIX CRÍTICO: ADICIONAR COACH_ID E ISOLAR DADOS POR COACH (V4)
-- ============================================
-- Este script corrige o vazamento de dados entre coaches
-- IMPORTANTE: Execute este script no SQL Editor do Supabase
-- V4: Corrigido estrutura da tabela messages
-- ============================================
...
-- ===== MENSAGENS =====
-- Estrutura: aluno_id (sempre o aluno), sender_id (quem enviou)

CREATE POLICY "Users can view their messages"
  ON messages FOR SELECT
  USING (
    auth.uid() = sender_id -- Quem enviou
    OR auth.uid() = aluno_id -- O aluno
    OR auth.uid() IN (
...
BEGIN
  ...
  RAISE NOTICE '1. Testar se coaches veem apenas seus próprios alunos';
  RAISE NOTICE '2. Vincular alunos existentes aos seus coaches se necessário';
  RAISE NOTICE '';
END $$;

-- Mostrar políticas criadas por tabela
SELECT
  tablename,
