...
-- Coaches podem ver todas as indicações
CREATE POLICY "Coaches podem ver indicações"
ON referrals FOR SELECT
USING (
  EXISTS (
...
-- Atualizar usuários existentes sem código (executar manualmente se necessário)
