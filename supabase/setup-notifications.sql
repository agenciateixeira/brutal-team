-- ============================================
-- SISTEMA DE NOTIFICAÇÕES - BRUTAL TEAM
...
DROP POLICY IF EXISTS "Coaches can create notifications for their students" ON notifications;
...
-- 6. Remover funções e triggers antigos (se existirem)
...
-- 9. Criar função para notificar protocolo
...
COMMENT ON COLUMN notifications.related_id IS 'ID do recurso relacionado';

-- ✅ Setup completo!
-- Agora as notificações serão criadas automaticamente quando coach ativar dieta/treino/protocolo
